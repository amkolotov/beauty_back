...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='salon',
            name='messengers',
            field=models.ManyToManyField(related_name='salon_messangers', to='salon.messenger'),
        ),
        migrations.AddField(
            model_name='sale',
            name='salons',
        ...
        migrations.AddField(
            ...
            name='img',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='salon.messengerimg', verbose_name='Иконка'),
        ),
        migrations.AddField(
            model_name='companyinfo',
            name='messengers',
            field=models.ManyToManyField(related_name='company_messangers', to='salon.messenger'),
        ),
    ]
