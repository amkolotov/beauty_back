...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='for_salons',
            field=models.ManyToManyField(blank=True, to='salon.salon', verbose_name='Для клиентов салонов'),
        ),
        migrations.AddField(
            model_name='notification',
            name='for_users',
            field=models.ManyToManyField(blank=True, related_name='personal_notifications', to=settings.AUTH_USER_MODEL, verbose_name='Для конкретных клиентов'),
        ),
        migrations.AddField(
            model_name='notification',
            name='read',
